    ...
    public void run(){
        ...
        */        
        ...
        for(CyEdge e : edgeList1){
            ...
            g1.addEdge(e.getSource(), e.getTarget());
        }
        
        UndirectedGraph<CyNode, CyEdge> g2 = new SimpleGraph<CyNode, CyEdge>(CyEdge.class);
        List<CyNode> nodeList2 = network1.getNodeList();
        List<CyEdge> edgeList2 = network1.getEdgeList();
        ...
        for(CyEdge e : edgeList2){
            ...
            g2.addEdge(e.getSource(), e.getTarget());
        }
        ...
        GraphIsomorphismInspector iso = AdaptiveIsomorphismInspectorFactory.createIsomorphismInspector(g1, g2, new NodeLabelEquivalenceComparator(), new EdgeLabelEquivalenceComparator());
